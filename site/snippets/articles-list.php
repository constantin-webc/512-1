<article id="<?= $article->title()->slug()?>" class="blog-item  <?php e($article->parent()->verticalView()->bool(), 'blog-item-blog')?>  blog-mini-thumb-item">
    <header>
    ...
    <?php if($article->parent()->verticalView()->bool()):?>
    ...
    <p><?= $article->headlineintro()->kt()?></p>
   

<?php if($article->articlelink()->isNotEmpty()):?>
    <a class="link-dark link-absolute" href="<?= $article->articlelink()->url()?>"><?= $article->articletitle()?></a>
<?php endif?>
</article>
